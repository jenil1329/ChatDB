# 🧠 ChatDB 21 – Natural Language Financial Data Query Engine

**ChatDB 21** is an AI-powered system that enables users to query financial market and sentiment data using natural language. It translates plain English queries into SQL and MongoDB queries, retrieves data from multiple sources, and presents results through interactive visualizations.
